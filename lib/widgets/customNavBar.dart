                    ...
                    GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          menu?Text(
                              "Menu",
                            style: TextStyle(color: AppColor.orange)):Text("Menu"),
                        ],
                      ),
                    ),
                    GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          offer?Text(
                              "Offers",
                              style: TextStyle(color: AppColor.orange)):Text("Offers"),
                        ],
                      ),
                    ),
                    SizedBox(width: 20,),
                    GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          profile ? Text(
                              "Profile",
                              style: TextStyle(color: AppColor.orange)):Text("Profile"),
                        ],
                      ),
                    ),
                    GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          more?Text(
                              "More",
                              style: TextStyle(color: AppColor.orange)):Text("More"),
                        ],
                      ),
                    ),
                  ],
